...
static constexpr std::array<uint32_t, 8> initial_hash_values
{
...
static constexpr void process_chunk(std::array<uint32_t, 8>& hash, const std::byte* p)
{
	uint32_t w[64] = { 0 }; // message schedule array
...
static constexpr void change_endianness(uint32_t& v)
{
	// TODO use std::byteswap when C++23 targeted.
	v = ((v & 0xff000000) >> 24) | ((v & 0xff0000) >> 8) | ((v & 0xff00) << 8) | ((v & 0xff) << 24);
}

static constexpr Module::SHA256Hash sha256(gsl::span<const std::byte> span)
{
...
#ifndef NDEBUG
// Statically verify the hash is correct.

// "", "E3B0C442 98FC1C14 9AFBF4C8 996FB924 27AE41E4 649B934C A495991B 7852B855");
static constexpr const std::byte test1[1] = {};
static constexpr Module::SHA256Hash hash1 = { 0x42C4B0E3,  0x141CFC98, 0xC8F4FB9A, 0x24B96F99, 0xE441AE27, 0x4C939B64, 0x1B9995A4, 0x55B85278 };
...
static constexpr const std::byte test2[1] = { std::byte{'a'} };
static constexpr Module::SHA256Hash hash2 = { 0x128197CA,  0xCABD1BCA, 0xB331C2FA, 0x4DDC239A, 0xF8EF86A7, 0x724E7C14, 0x857780B9, 0xBB48EEAF };
...
namespace Module {
	...
	{
		gsl::span<const std::byte> span(reinterpret_cast<const std::byte*>(first), last - first);
		return sha256(span);
	}
