...
class DeclIndex {
    static Sort = {
        ...
        Tuple:                   27, // A sequence of declarations.
...
class ExprIndex {
    static Sort = {
        ...
        NamedDecl:                 5,  // Use of a name to reference a declaration.
        ...
        Temporary:                 18, // A temporary expression.
        Call:                      19, // An invocation of some form of callable expression.
        ...
        ExpressionList:            26, // The sequence of expressions in either '(e1, e2, e3)' or '{ e1, e2, e2 }'
        SizeofType:                27, // 'sizeof(type-id)'.  FIXME: See bug https://github.com/microsoft/ifc-spec/issues/130
        Alignof:                   28, // 'alignof(type-id)'.  FIXME: See bug https://github.com/microsoft/ifc-spec/issues/131
        ...
        StringSequence:            36, // A sequence of string literals.
                                       // FIXME: See bug https://github.com/microsoft/ifc-spec/issues/132
        Initializer:               37, // An initializer for an object
        Requires:                  38, // A requires expression
        UnaryFold:                 39, // A unary fold expression of the form (pack @ ...)
        BinaryFold:                40, // A binary fold expression of the form (expr @ ... @ pack)
        ...
        VirtualFunctionConversion: 47, // A conversion of a virtual function reference to its underlying target: C::f // 'f'
        ...
        Statement:                 55, // A statement expression.
...
class DirIndex {
    static Sort = {
        VendorExtension:   0, // Vendor-specific extension for directives.
        Empty:             1, // An empty declaration - ;
        Attribute:         2, // Attribute declaration - [[nodiscard]].
        Pragma:            3, // Pragma directive - _Pragma
        Using:             4, // Using-directive declaration - using namespace N
        DeclUse:           5, // Using declaration - using ::X
        Expr:              6, // Phased-evaluation of an expression - static_assert, asm-declaration, etc.
        StructuredBinding: 7, // Structured binding declaration - auto [a, b, c] = x
        SpecifiersSpread:  8, // A spread of sequence of decl-specifiers over a collection of init-declarators in a single
                              // grammatical declaration - int* p, i, **x, ...
        Unused0:           9, // Empty slot
        Unused1:           10, // Empty slot
        Unused2:           11, // Empty slot
        Unused3:           12, // Empty slot
        Unused4:           13, // Empty slot
        Unused5:           14, // Empty slot
        Unused6:           15, // Empty slot
        Unused7:           16, // Empty slot
        Unused8:           17, // Empty slot
        Unused9:           18, // Empty slot
        Unused10:          19, // Empty slot
        Unused11:          20, // Empty slot
        Unused12:          21, // Empty slot
        Unused13:          22, // Empty slot
        Unused14:          23, // Empty slot
        Unused15:          24, // Empty slot
        Unused16:          25, // Empty slot
        Unused17:          26, // Empty slot
        Unused18:          27, // Empty slot
        Unused19:          28, // Empty slot
        Unused20:          29, // Empty slot
        Unused21:          30, // Empty slot
        Tuple:             31, // A collection of directives
        Count:             32
    };
